...
const libraryFunctions = {
    ...
    "collections": ["map", "rand_int_list", "rand_float_list", "filter", "reduce", "min", "max", "reverse", "zip", "zip_longest", "sort", "count", "index_of", "merge", "invert", "from_keys", "any", "all", "find", "unique", "map_values", "map_filter"],
